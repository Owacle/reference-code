...
from PySide import QtGui,QtCore,shiboken  # @UnresolvedImport
...
class ToolBoxMenuBar(QtGui.QMenuBar):
    ...
    def reorderHistory(self):
        ...
        MayaScripts.reorderHistory(listOrder, geos)
        om.MGlobal.displayInfo('reordered history') 
...
class ToolBoxWidget(QtGui.QWidget):
    ...
    def __init__(self,parent = None):
        ...
        #save
        saveClustersButton  = ButtonPopUpMenu()
        saveClustersButton.button.setText('Save Clusters')
        saveClustersButton.button.setGeometry(60,33,60,33)
        saveClustersButton.addMenuItem('Save', ToolBoxFn.saveClusters)
        saveClustersButton.addMenuItem('Load', ToolBoxFn.loadClusters)
        ...
        gridLayout.addWidget(saveClustersButton,1,1)
